...
import { SkeletonRow, SkeletonPage } from "../../../components/ui/Skeleton";
          ...
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                {[1, 2, 3, 4, 5].map((i) => (
                  <tr key={i}>
                    <td colSpan={4} style={{ padding: 0 }}><SkeletonRow /></td>
                  </tr>
                ))}
              </tbody>
            </table>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse" }}>
              ...
              <tbody>
                ...
                {data.issues?.length === 0 && (
                  <tr><td colSpan={4} style={{ padding: "1rem" }}><EmptyState icon="📋" title="No issues found" subtitle="Create your first issue to get started." /></td></tr>
                )}
              </tbody>
            </table>
          </div>
